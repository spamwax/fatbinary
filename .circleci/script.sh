...
SDKROOT=$(xcrun -sdk macosx11.3 --show-sdk-path) MACOSX_DEPLOYMENT_TARGET=$(xcrun -sdk macosx11.3 --show-sdk-platform-version) cargo build --target=aarch64-apple-darwin
